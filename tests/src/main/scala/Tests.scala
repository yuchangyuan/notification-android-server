package me.ycy.notification.server.android.tests

import me.ycy.notification.server.android._
...
class AndroidTests extends AndroidTestCase {
  def testPackageIsCorrect() {
    assertEquals("me.ycy.notification.server.android", getContext.getPackageName)
  }
}
